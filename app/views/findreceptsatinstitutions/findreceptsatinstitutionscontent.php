    ...
    <div class = "homepagebackgroundPic">
        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    <li>
                        <a href="#">Enter a receptionist from <?php print_r($data['institution_name']); echo '  '.  '<span>' . htmlspecialchars($data['institution_city']) . ', ' . htmlspecialchars($data['institution_state']) . '</span><br>';?></a>
                    </li>
                </ul>
